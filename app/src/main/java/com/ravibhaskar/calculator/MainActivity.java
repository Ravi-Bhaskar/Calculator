package com.ravibhaskar.calculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void trigNaturalLogBTNPush(View view){
        updateText("ln(");
    }
    ...
    public void trigPiBTNPush(View view){
        updateText("pi(");
    }

    public void trigAbsoluteValueBTNPush(View view){
        updateText("abs(");
    }
    ...
    public void trigXSquaredBTNPush(View view){
        updateText("^(2)");
    }
